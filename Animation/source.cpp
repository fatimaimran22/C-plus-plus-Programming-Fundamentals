#include<iostream>
#include<conio.h>
#include"help.h" //name of the header file should be correct in order to run the file

using namespace std;

//Assignemnt Animation fatimaimran22
...
int main()
{
	sun(500,200,700,700,255,0,0,255,0,0);
	//sky
...
//fatimaimran22 animation assignment
